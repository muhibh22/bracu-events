        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">Book Room</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        <h4>Select Room No</h4>
                        <form action="{{ url('/') }}/dept_room_store" enctype="multipart/form-data"
                            method="POST">
                            ...
                            <select name="room_name" class="input">
                                <option disabled="disabled" selected="selected">Room: UB-</option>
