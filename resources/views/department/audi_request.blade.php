...
<head>
    ...
    <title>Request Autditorium</title>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="hero-area-tree">
                        ...
                        <li>Request Auditorium</li>
                    </ul>
                    <h1 class="white-text">Request for Auditorium</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form action="{{ url('/') }}/audi_request_store" enctype="multipart/form-data"
                            method="POST">
                            ...
                            <input class="input" type="text" name="name" placeholder="Reason For Request">
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <div class="widget tags-widget">
                        <h3>Tags</h3>
                        <a class="tag" href="{{ url('/') }}/admin_request">Request Auditorium</a>
