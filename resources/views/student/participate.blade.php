            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="hero-area-tree">
                        ...
                        <li>Event Participate</li>
                    </ul>
                    <h1 class="white-text">Participate an Event</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form action="{{ url('/') }}/participate_store" method="POST">
                            ...
                            <input class="input" type="text" name="event_name" placeholder="Enter Event Name">
                            ...
                            <button class="main-button icon-button pull-right">participate</button>
                        </form>
                    </div>
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <div id="aside" class="col-md-3">
                        ...
                        <div class="widget tags-widget">
                            <h3>Tags</h3>
                            <a class="tag" href="{{ url('/') }}/participate">Participate an Event</a>
                            <a class="tag" href="{{ url('/') }}/feedback">Give Feedback on an Event</a>
                            <a class="tag" href="{{ url('/') }}/roomstatus">Check Room availability</a>
                        </div>
                        <!-- /tags widget -->
