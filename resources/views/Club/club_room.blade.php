        ...
        <div class="container">
            ...
            <nav id="nav">
                <ul class="main-menu nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ url('/') }}/clublogout">logout</a></li>
                </ul>
            </nav>
            <!-- /Navigation -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">Request for room</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form action="{{ url('/') }}/club_room_store" enctype="multipart/form-data"
                            method="POST">
                            ...
                            <input class="input" type="text" name="request_maker" placeholder="Request for">
                            <span class="text-danger">
                                @error('request_maker')
                                    {{ $message }}
                                @enderror
                            </span>
                            <select name="room_name" class="input">
                            ...
                            <button class="main-button icon-button pull-right">Request</button>
                        </form>
                    </div>
                </div>
                <!-- /contact form -->
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <div class="widget tags-widget">
                        <h3>Tags</h3>
                        <a class="tag" href="{{ url('/') }}/club_event">Request For an Event</a>
                        <a class="tag" href="{{ url('/') }}/club_room">Request for Room</a>
                        <a class="tag" href="{{ url('/') }}/club_sound">Request for Sound System</a>
                    </div>
                    <!-- /tags widget -->
