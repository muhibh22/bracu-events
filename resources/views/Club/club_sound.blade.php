        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">Request for Sound</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form action="{{ url('/') }}/club_sound_store" enctype="multipart/form-data"
                            method="POST">
                            ...
                            <input class="input" type="text" name="request_by" placeholder="Request For">
                            ...
                            <button class="main-button icon-button pull-right">Make Request</button>
                        </form>
                    </div>
                </div>
                <!-- /contact form -->
