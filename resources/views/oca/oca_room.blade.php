        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9">
                    ...
                    <!-- row -->
                    <div class="row">
                        @foreach ($room_reqs as $room_req)
                            <!-- single blog -->
                            <div class="col-md-6">
                                <div class="single-blog">
                                    <h4>UB{{ $room_req->room_name }}</h4>
                                    <p>
                                        Request by: {{ $room_req->request_maker }}
                                    </p>
                                    <a href="{{ url('/oca_rooms_add/') }}/{{ $room_req->request_id }}">
                                        <button class="button-12">Accept</button> <br>
                                    </a>
                                    <a href="{{ url('/oca_rooms_delete/') }}/{{ $room_req->request_id }}">
                                        <button class="button-13">Reject</button> <br>
                                    </a>
                                </div>
                            </div>
                            <!-- /single blog -->
