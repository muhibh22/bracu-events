        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="{{ url('/') }}/clublogin_check" method="POST">
                        @if (Session::get('fail'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="input--style-4" type="email" name="club_mail">
                        ...
                        <div class="form-group">
                            ...
                            <input class="input--style-4" type="password" name="club_password">
                            <span class="text-danger">
                                @error('club_password')
                                    {{ $message }}
                                @enderror
