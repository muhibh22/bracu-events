    ...
    <div class="page-wrapper p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">OCA Login</h2>
                    <form action="{{ url('/') }}/ocalogin_check" method="POST">
                        @if (Session::get('fail'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="input--style-4" type="email" name="oca_mail">
                        ...
                        <div class="form-group">
                            ...
                            <input class="input--style-4" type="password" name="oca_password">
                            <span class="text-danger">
                                @error('oca_password')
                                    {{ $message }}
                                @enderror
